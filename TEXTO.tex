...
\begin{bibliohedra}
\tit{adorno}, Theodor \textsc{w}. \textit{Estudos sobre a personalidade autoritária}. São Paulo: Editora Unesp, 2019.

\titidem. Educação após Auschwitz. \textit{In}: \line(1,0){25}. \textit{Educação e emancipação}. São Paulo: Paz \& Terra, 2020.

\tit{allcott}, \textsc{h}. e \textsc{gentzkow}, \textsc{m}. ``Social media and fake news in the
2016 election''. \textit{In: Journal of Economic Perspectives}, v.\,31, n.\,2, p.\,211--236, 2017.

\tit{almeida}, Silvana \textsc{l}. \textit{et al.} WhatsApp: a desordem da informação na
