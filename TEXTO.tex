...
Desinformação circula como numa câmara de eco
...
A inédita guerra do Brasil de Bolsonaro contra a vacinação 
...
Da desinformação nas campanhas eleitorais à ação governamental

A desinformação como prática do governo

Reviravoltas no cenário político de 2021

\textbf{Capítulo 3 -- Fake news e a ordem do discurso desinformativo }

3.1. Algumas noções e conceitos

Papel das plataformas digitais na circulação da desinformação 

Semeando a desconfiança
...
Projetos de lei para enfrentar a desinformação
...
\begin{bibliohedra}
\tit{BRAMATI}, Daniel, MONNERAT, Alessandra, BRENBATI, Katia,
...
\tit{CEPEDISA}, CONECTAS, \textbf{Boletim no. 10 -- Direitos na Pandemia -}
...
\tit{DANOWSKI}, Deborah, \textbf{NEGACIONISMOS,} São Paulo: n-1, 2018

\tit{DAVIS}, Mike, \textbf{~O coronavírus e a luta de classes: o monstro bate
...
\tit{DIEESE}. \textbf{Custo da cesta básica aumenta em 10 capitais.} Diese.org
05.03.2020 Disponível em
\emph{https://www.dieese.org.br/analisecestabasica/2020/202002cestabasica.pdf},
Acesso em 02.07.2020.

\tit{FOUCAULT}, Michel, \textbf{O nascimento da biopolítica,} São Paulo:
Martins Fontes, 2008

\tit{GRANDIN} Felipe. \textbf{É \#FAKE que pesquisa recente indique a
...
\tit{LUPA}. \textbf{Verifica Coronavírus EP05: a onda de desinformação nos
...
\tit{MBEMBE} Achille. \textbf{Necropolítica}. Tradução de Renata Santine, Ed.
M1, São Paulo, 2018.
...
\tit{MENESES}, Luís Fernando\textbf{. Nobel de Medicina não disse que novo
...
\tit{MINISTERIO DA SAÚDE}. \textbf{O que você precisa saber sobre o
coronavirus}. Disponível em:
\emph{https://coronavirus.saude.gov.br/}
Acesso em: 14.06.2020.

\tit{MORAES} Mauricio. \textbf{Brasil lidera desinformação sobre número de
...
\tit{PAHO.ORG.ISH}. \textbf{Entenda a Infodemina e a Desinformação na Luta
...
\tit{G1}, \textbf{Datafolha: 73\% dizem que pretendem tomar vacina contra
...
\tit{RUDNITZKI}, Ethel; SCOFIELD Laura. \textbf{Robôs levantaram hashtag que
...
\tit{UJVARI}, Stefan Cunha. \textbf{A história da humanidade contada pelos
...
\section{Da desinformação nas campanhas eleitorais à ação governamental}
...
\begin{bibliohedra}
\tit{ADORNO}, Theodor W. \textbf{A personalidade autoritária.} Disponível em:
...
\tit{ALMEIDA}, Silvana L, RAMOS, CARVALHO, Priscila R., EVANGELO, Naiara,
...
\tit{ARENDT}, Hannah. \textbf{Entre o passado e o Futuro}. São Paulo: Editora
Perspectiva, 1997.

\tit{DATAFOLHA}. \textbf{Relatório Uso das redes sociais -- Instituto
...
\tit{GAGLIONI}, Cesar. \textbf{O que há sobre o Brasil nos documentos da
...
\tit{HECLO}, H. Campaigning and governing: a conspectus. In: ORNSTEIN. N. J.;
MANN, T. E. (Eds.); \textbf{The Permanent Campaign and Its Future}.
American Enterprise Institute and The Brookings Institution, 2000

\tit{LIBÓRIO}, Barbara, CUNHA, Ana R. \textbf{Notícias falsas foram
...
\tit{MACHADO}, Caio, KONOPACKI, Marco, \textbf{Poder computacional : automação
...
\tit{MELO}, Patrícia C. \textbf{Empresários bancam campanha contra o PT pelo
WhatsAppp.} Folha Uol.com. 18.10.18. Disponível em: \textless{}

\tit{RUNCIMAN}, David, \textbf{Como a democracia chega ao fim.} São Paulo:
Todavia, 2018.

\tit{TRIBUNAL SUPERIOR ELEITORAL} (2018), \textbf{REPRESENTAÇÃO.} Disponível
em
\emph{https://www.conjur.com.br/dl/decisao-tse-fake-news-video-mamadeira.pdf}\textgreater{}.
Acesso em 14.07.2020\textgreater{}.

\tit{SILVERMAN}, Craig. \textbf{This Analysis Shows How Fake Election News
...
\begin{bibliohedra}
\tit{Allcott}, H., \& Gentzkow, M.. \textbf{Social media and fake news in the
2016 election. Journal of Economic Perspectives}, vol 31(2), 211-236,
(2017)

\tit{BEZERRA}, Arthur; CAPURRO, Rafael; SCHNEIDER, Marco. \textbf{Regimes de
...
\tit{BOUNEGRU}, Liliana, GRAY, Jonathan, VENTURINI, Tommaso, MAURI, Michele,
...
\tit{CGI.BR}. Comitê Gestor da Internet no Brasil. \textbf{Relatório Internet,
...
\tit{CHICARINO}, T., Raíces, C., SEGURADO, R., FERRAZ, ., \textbf{Como dois
...
\tit{CONCIL OF EURPE REPORT DGI}. \textbf{Information Disorder: Toward an
...
\tit{DARNTON}, Robert. \textbf{A verdadeira história das notícias falsas}. El
...
\tit{ELIAS}, NORBERT e SCOTSON, Jhon. \textbf{Estabelecidos e outsiders}.
Tradução de Vera Ribeiro e Pedro Süssekind., Petrópolis Ed. Zahar, 1994.

\tit{GLOBAL DESINFORMATION INDEX}, \textbf{The Quarter Billion Dollar
...
\tit{MOROZOV}, Evgeny. \textbf{Big Tech -- a ascensão dos dados e a
morte da política.} São Paulo Ed. UBU, 2018.

\tit{NIELSEN}, Jakob. \textbf{Website Reading: It (Sometimes) Does
Happen}.~Nielsen Norman Group, 2013. Disponível
em: \emph{https://www.nngroup.com/articles/website-reading/},
Acesso em: 07.07.2020.~

\tit{PARISIER}, Eli, \textbf{O filtro invisível -- o que a internet está
escondendo de você,} Rio de Janeiro: Zahar, 2012.

\tit{POSETTI}, Julie; MATTHEWS, Alice. \textbf{Una breve guía de la historia
...
\tit{SCAMPARINI}, Ilze. ``Todo fundamentalismo quase
...
\tit{SILVEIRA}, Sergio Amadeu. \textbf{Democracia e os códigos
invisíveis: como os algoritmos estão modulando comportamentos e escolhas
política}. São Paulo: Edições Sesc, 2019.

\tit{SRNICEK}, Nick, \textbf{Plataform Capitalism,} Polity Press, 2016

\tit{WARDLE}, Claire. \textbf{First Draft.} Disponível em:
