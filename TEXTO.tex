...
\begin{epigraphs}
\qitem{A mentira se converte em ordem universal.}{\textsc{franz kafka}}
\end{epigraphs}
...
durante a pandemia, alimentando as redes de desinformação e criando
...
recuperando o debate sobre a desinformação e \textit{fake news}, discutindo o
...
No terceiro capítulo abordaremos os principais conceitos e teorias sobre esses
termos \textit{fake news}, desinformação e pós-verdade, aspecto fundamental para
qualificarmos esse debate, tendo em vista que \textit{fake news}, além de ser um
...
financiamento à sites que produzem e compartilham \textit{fake news}. Também
...
Estudo realizado por economistas da Fundação Getúlio Vargas (\textsc{fgv}) em
...
\tit{MELO}, Patrícia C. \textbf{Empresários bancam campanha contra o \textsc{pt} pelo
...
Wardle e Derakhshan (2017) também descartaram o uso de \textit{fake news}
